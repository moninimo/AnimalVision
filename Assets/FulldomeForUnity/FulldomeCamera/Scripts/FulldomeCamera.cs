...
namespace Avante
{
	...
	public enum Face      
	{
		...
		PositiveZ = (1 << CubemapFace.PositiveZ),//front 
		NegativeZ = (1 << CubemapFace.NegativeZ),//back
	}
	...
	public class FulldomeCamera : MonoBehaviour
	{
		...
		Material _cubemapToCylinderMaterial;
		Material CubemapToDomeMaterial
		 {
            get
            {
                ...
                {
                    if (!_cubemapToCylinderMaterial)
                        _cubemapToCylinderMaterial = new Material(Shader.Find("Avante/CubemapToCylinder"));
                    return _cubemapToCylinderMaterial;
                }
            }
        }
